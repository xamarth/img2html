...
def main():
    ...
    parser.add_argument("-c", "--char", default="爱", metavar="CHAR", help="characters")
    parser.add_argument(
        "-t", "--title", default="img2html by xlzd", metavar="TITLE", help="html title"
    )
    parser.add_argument(
    ...
    parser.add_argument("-o", "--out", default=None, metavar="OUT", help="output file")
